...
#ifndef AUTOWARE__MTR__MTR_NODE_HPP_
#define AUTOWARE__MTR__MTR_NODE_HPP_
...
{
/**
 * @brief A ROS 2 node class for mtr.
 */
...
public:
  ...
  /**
   * @brief Construct a new MTRNode object.
   *
...
#endif  // AUTOWARE__MTR__MTR_NODE_HPP_
