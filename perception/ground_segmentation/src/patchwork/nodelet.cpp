  ...
  tgr_params_(this)
{
  ...
  sub_cloud_ = create_subscription<sensor_msgs::msg::PointCloud2>(
    ...
    std::bind(&PatchWorkComponent::cloud_callback, this, std::placeholders::_1));
...
void PatchWorkComponent::cloud_callback(sensor_msgs::msg::PointCloud2::ConstSharedPtr cloud_msg)
{
  if (debug_) {
...
std::queue<size_t> PatchWorkComponent::remove_reflected_noise(
...
void PatchWorkComponent::sample_initial_seed(
...
void PatchWorkComponent::region_wise_plane_fitting(
...
void PatchWorkComponent::estimate_vertical_plane(
...
void PatchWorkComponent::estimate_ground_plane(
...
void PatchWorkComponent::estimate_plane(const pcl::PointCloud<PointT> & ground_cloud)
{
...
void PatchWorkComponent::temporal_ground_revert(
...
void PatchWorkComponent::update_elevation_thresholds()
{
...
void PatchWorkComponent::update_flatness_thresholds()
{
  for (size_t m = 0; m < czm_params_.num_near_ring(); ++m) {
...
void PatchWorkComponent::update_height_threshold()
{
...
void PatchWorkComponent::cloud_to_czm(
